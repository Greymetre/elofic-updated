  ...
  var table = $('#getattendance').DataTable({
      'destroy': true,
        ...
        columns: [
            ...
            {data: 'beatCounters', name: 'beatCounters',"defaultContent": ''},
            {data: 'visitedcounter', name: 'visitedcounter',"defaultContent": ''},
            {data: 'beatadherence', name: 'beatadherence',"defaultContent": ''},
            {data: 'totalorder', name: 'totalorder',"defaultContent": ''},
            {data: 'beatproductivity', name: 'beatproductivity',"defaultContent": ''},
            {data: 'newcounter', name: 'newcounter',"defaultContent": ''},
            {data: 'orderqty', name: 'orderqty',"defaultContent": ''},
            {data: 'uniqueskucount', name: 'uniqueskucount',"defaultContent": ''},
            {data: 'ordervalue', name: 'ordervalue',"defaultContent": ''},
            {data: 'dailyAvarageSales', name: 'dailyAvarageSales',"defaultContent": ''},
        ]
    });
