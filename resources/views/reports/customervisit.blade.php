  ...
  var token = $("meta[name='csrf-token']").attr("content");
    oTable = $('#getattendance').DataTable({
        ...
        "columns": [
            ...
            {data: 'checkout_time', name: 'checkout_time',"defaultContent": '', orderable: false, searchable: false },
            {data: 'visit_time', name: 'visit_time',"defaultContent": '', orderable: false, searchable: false },
            ...
            {data: 'customers.mobile', name: 'customers.mobile',"defaultContent": ''},
            ...
            {data: 'ordersum', name: 'ordersum',"defaultContent": '', orderable: false, searchable: false },
            {data: 'uniquesku', name: 'uniquesku',"defaultContent": '' , orderable: false, searchable: false },
            {data: 'uniqueorder', name: 'uniqueorder',"defaultContent": '', orderable: false, searchable: false },
            {data: 'remarks', name: 'remarks',"defaultContent": '' , orderable: false, searchable: false },
