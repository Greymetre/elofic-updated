        ...
        <h4 class="card-title">Loyalty Summary Retailer Wise Report
          <span class="">
            <div class="btn-group header-frm-btn">
              ...
              <form method="GET" action="{{ URL::to('loyalty-retailer-wise-report-download') }}">
  ...
  $(function () {
    ...
    var table = $('#getbranchsummarydealerwise').DataTable({
        ...
        columns: [
            ...
            {data: 'customeraddress.statename.state_name', name: 'customeraddress.statename.state_name',"defaultContent": ''},
            {data: 'customeraddress.cityname.city_name', name: 'customeraddress.cityname.city_name',"defaultContent": ''},
            {data: 'branch', name: 'branch',"defaultContent": ''},
