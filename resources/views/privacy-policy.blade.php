<x-guest-layout>
    <section id="sales-main">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-12 col-md-12 d-flex text-justify">
                    <div class="sales-box-content w-100" style="margin-top: 20px !important;">
                        ...
                        <h6 class="pt-4">1. ABOUT THE APP</h6>
                        ...
                        <ul>
                            ...
                            <li>Visit customer shops and check in at customer locations.</li>
                        ...
                        <h6 class="pt-4">2. INFORMATION WE COLLECT</h6>
                        <p>We collect the following information when you use the App:</p>

                        <p class="mb-1"><strong>A. Personal &amp; Account Information</strong></p>
                        <ul>
                        ...
                        <p class="mt-3 mb-1"><strong>D. Device Information</strong></p>
                        <ul>
                            <li>Device model, operating system version, and unique device identifiers.</li>
                        </ul>

                        <h6 class="pt-4">3. HOW WE USE YOUR INFORMATION</h6>
                        ...
                        <h6 class="pt-4">4. DATA SHARING</h6>
                        ...
                        <h6 class="pt-4">5. DATA STORAGE AND SECURITY</h6>
                        ...
                        <h6 class="pt-4">6. DATA RETENTION</h6>
                        ...
                        <h6 class="pt-4">7. YOUR RIGHTS</h6>
                        ...
                        <div class="mt-5 pt-4 border-top">
                            ...
                            <p class="mb-3">If you have any questions or concerns regarding this Privacy Policy or how your data is handled, please contact us.</p>
                            <p><strong>Greymetre Consultants Pvt. Ltd.</strong></p>
                            <a href="mailto:info@greymetre.io?subject=FieldKonnect%20Privacy%20Policy"
                               class="btn btn-primary btn-lg px-5 py-3 d-inline-flex align-items-center gap-2">
                                <i class="fas fa-envelope"></i>
                                Email Us
                            </a>
                            <p class="mt-3 text-muted small">
                                Email: <a href="mailto:info@greymetre.io?subject=FieldKonnect%20Privacy%20Policy" class="text-decoration-underline">info@greymetre.io</a>
                            </p>
                        </div>
                        ...
                        <div class="text-center mt-5 pt-4 border-top text-muted small">
                            <p>&copy; Greymetre Consultants Pvt. Ltd. All Rights Reserved.</p>
                        </div>
                    </div>
                </div>
            </div>
