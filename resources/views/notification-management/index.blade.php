<x-app-layout>
    <style>
        ...
        .news-user-control {
            ...
            background: #fff; color: #495057; box-shadow: none;
        }
        .news-user-control::after {
            content: ''; position: absolute; right: 16px; top: 19px;
            border: 4px solid transparent; border-top-color: #707070;
        }
        .news-user-multiselect.open .news-user-control {
            border-color: #3860a4; background: #fff;
            box-shadow: 0 0 0 2px rgba(56, 96, 164, .15);
        }
        .news-user-placeholder { color: #495057; font-size: 13px; font-weight: 300; white-space: nowrap; }
        .news-user-selected {
        ...
        .news-user-chip {
            ...
            padding: 3px 7px; border: 1px solid #d2d2d2; border-radius: 6px;
            background: #eef3fa; color: #495057; font-size: 13px; font-weight: 300;
        }
        ...
        .news-user-dropdown {
            ...
            padding: 10px; overflow: hidden; border: 1px solid #d2d2d2;
            border-radius: 4px; background: #fff; box-shadow: 0 8px 24px rgba(0,0,0,.16);
        }
        ...
        .news-user-search {
            ...
            border: 1px solid #d2d2d2 !important; border-radius: 10px !important;
        ...
        .news-user-option:hover { background: #eef3fa; }
        form #userMultiselect .news-user-option input[type="checkbox"] {
            ...
            margin: 0 !important; padding: 0 !important; border: 1px solid #d2d2d2 !important;
            border-radius: 4px !important; background: #fff !important; cursor: pointer;
        }
        form #userMultiselect .news-user-option input[type="checkbox"]:checked {
            border-color: #3860a4 !important; background-color: #3860a4 !important;
            background-image: linear-gradient(135deg, transparent 45%, #fff 45%, #fff 58%, transparent 58%),
                linear-gradient(45deg, transparent 32%, #fff 32%, #fff 45%, transparent 45%) !important;
        }
        ...
        .news-user-empty { padding: 12px; color: #999; font-size: 13px; }
