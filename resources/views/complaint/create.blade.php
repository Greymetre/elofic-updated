         ...
         <div class="card mt-0 p-0">
                     ...
                     <div class="row mt-3">
                           ...
                           <div class="col-md-4">
                              <div class="input_section">
                                 ...
                                 <input type="text"
                                          ...
                                          id="part_no"
                                          class="form-control"
                                          value="{{ old('part_no', $complaints['part_no'] ?? '') }}">
                           ...
                           <div class="col-md-4">
                              <div class="input_section">
                                 ...
                                 <input type="text"
                                          ...
                                          id="batch_no"
                                          class="form-control"
                                          value="{{ old('batch_no', $complaints['batch_no'] ?? '') }}">

                                 @if ($errors->has('batch_no'))
                                       <div class="error">
                                          <p class="text-danger">{{ $errors->first('batch_no') }}</p>
                                       </div>
                                 @endif
                              </div>
                           </div>
                           ...
                           <div class="col-md-4">
                              <div class="input_section">
                                 ...
                                 <select name="distributor_id" id="distributor_id" class="select2 form-control">
                                       <option value="">Select Distributor</option>

                                       @foreach($distributors as $distributor)
                                          <option value="{{ $distributor->id }}"
                                             {{ old('distributor_id', $complaints['distributor_id'] ?? '') == $distributor->id ? 'selected' : '' }}>
                        ...
                        <div class="contact_details mt-2">
                           ...
                           <div class=" rounded p-2">
                              ...
                              <div class="row mt-3">
                                 ...
                                 <div class="col-md-6">
                                    <div class="input_section">
                                          <label class="col-form-label">Search Customer Number</label>
                                          <input type="number"
                                 ...
                                 <div class="col-md-6">
                                    <div class="input_section">
                                       ...
                                       <input type="text"
                                                ...
                                                inputmode="numeric"
                                                pattern="[0-9]*"
                                                value="{{ old('whatsapp_number', $complaints['whatsapp_number'] ?? '') }}">
                                          ...
                                          <div class= "mt-2">
                                             <label>
                                                <input type="checkbox"
                                                      ...
                                                      value="1"
                                                      {{ old('same_as_contact', $complaints['same_as_contact'] ?? 0) ? 'checked' : '' }}>
                              ...
                              <div class="row mt-3">
                                 ...
                                 <div class="input_section">
                                    ...
                                    <input type="text" name="customer_name" id="custom_customer_name"
                                             class="form-control " placeholder="Enter custom customer name"
                                             style="display:none;">
                                 ...
                                 <div class="col-md-6">
                                    <div class="input_section">
                                       ...
                                       <input type="text"  name="customer_email" id="customer_email" class="form-control" value="{!! old( 'customer_email', $complaints['customer_email']) !!}">
                                 ...
                                 <div class="col-md-3">
                                    <div class="input_section">
                                       ...
                                       @if ($errors->has('whatsapp_number'))
                                             <div class="error">
                                                <p class="text-danger">{{ $errors->first('whatsapp_number') }}</p>
                                             </div>
                                       @endif
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-md-9">
                                    <div class="input_section">
                                       ...
                                       <div class="row mt-3">
                                          ...
                                          @if($complaints->exists && !empty($complaints->attachment_file))

                                             @php
                                                $extension = strtolower(pathinfo($complaints->attachment_file, PATHINFO_EXTENSION));
                                             @endphp

                                             <div class="mt-3">

                                                <a href="{{ asset('storage/'.$complaints->attachment_file) }}"
                                                   target="_blank">

                                                      @if(in_array($extension,['jpg','jpeg','png']))
                                                         <img
                                                            src="{{ asset('storage/'.$complaints->attachment_file) }}"
                                                            class="rounded img-fluid"
                                                            style="width:170px;height:170px;"
                                                         >
                                                      @elseif($extension == 'pdf')
                                                         <img
                                                            src="{{ asset('assets/img/pdf-icon.jpg') }}"
                                                            class="rounded img-fluid"
                                                            style="width:170px;height:170px;"
                                                         >
                                                      @endif
            ...
            <script>
                  ...
                  $.ajax({
                     ...
                     success: function(res) {
                        if (res.status === true) {
                           ...
                           $("#whatsapp_number").val(res.data.whatsapp_number);
               ...
               $(document).ready(function() {
                  ...
                  $('#same_as_contact').trigger('change');
                  ...
                  $('#storeComplaintData').on('submit', function () {

                     console.log(
                        document.getElementById('voice_note_file').files
                     );

                     console.log(
                        document.getElementById('voice_note_file').files.length
                     );
                  });
                  ...
                  // Same as Contact Number
                  $('#same_as_contact').on('change', function () {

                     if ($(this).is(':checked')) {
                        $('#whatsapp_number').val($('#customer_number').val());
                        $('#whatsapp_number').prop('readonly', true);
                     } else {
                        $('#whatsapp_number').val('');
                  ...
                  // If customer number changes and checkbox is checked
                  $('#customer_number').on('keyup change', function () {
                  ...
                  $('#startRecording').click(async function () {
                     ...
                     mediaRecorder.ondataavailable = function (event) {
                        ...
                        audio.onloadedmetadata = function () {
                           $('#audioDuration').text(
                              formatTime(Math.floor(audio.duration))
                           );
                        };

                        const sizeKB = (audioBlob.size / 1024).toFixed(2);

                        $('#audioSize').text(sizeKB + ' KB');
                        ...
                        document.getElementById('voice_note_file').files = dt.files;
