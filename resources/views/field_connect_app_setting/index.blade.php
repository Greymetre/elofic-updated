         ...
         <div class="card p-0 m-0">
            ...
            <div class="card-body">
               <div class="row">
                  ...
                  @if(isset($field_konnect_app_setting) && $field_konnect_app_setting->getMedia('product_catalogue')->count() > 0 && file_exists($field_konnect_app_setting->getMedia('product_catalogue')[0]->getPath()))
