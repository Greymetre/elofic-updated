            ...
            <div class="col-12">
              <h4>
                ...
                <small class="float-right">
                  <input type="text" name="invoice_date" class="form-control datepicker"value="{!! old( 'invoice_date', $sales['invoice_date']) !!}" autocomplete="off" readonly>
          ...
          <div class="row invoice-info">
                    ...
                    <div class="col-sm-4 invoice-col">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="invoice_no" value="{!! old( 'invoice_no', $sales['invoice_no']) !!}" required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
                              <input type="text" class="form-control" name="orderno" value="{!! old( 'orderno', $sales['orderno']) !!}" required>
                                  ...
                                  <tbody >
                                    @if($sales->exists && isset($sales['saledetails']))
                                      @foreach($sales['saledetails'] as $index => $rows )
                                        ...
                                        <td width="20%">
                                            <input type="number" name="saledetail[{!! $index !!}][price]" class="form-control price rowchange" step="0.00" min="0" value="{!! $rows['price'] !!}" />
                                            <div class='error-price'></div>
                                        </td>
                                        <td>
                                          <input type="number" name="saledetail[{!! $index !!}[discount]" class="form-control discount rowchange" step="0.00" min="0" value="{!! $rows['discount'] !!}" />
                                          <div class='error-discount'></div>
                                       </td>
                                        <td width="15%">
                                            <input type="number" name='saledetail[{!! $index !!}][quantity]' class="form-control quantity rowchange" step="0" min="0" value="{!! $rows['quantity'] !!}" />
