         ...
         <div class="menu-bar">
                  ...
                  <li class="nav-link {{ request()->is('expenses*') ? 'active' : '' }}">
                     ...
                     <div class="collapse" id="accountMenu" style="">
                        <ul class="navd">
                           ...
                           <li class="nav-link-btn {{ request()->is('expenses') ? 'active' : '' }}">
                           ...
                           <li class="nav-link-btn">
                              <a class="hoveradd2" data-toggle="collapse" href="#paymentManu" aria-expanded="false">
                  ...
                  <ul class="navd">
                     ...
                     <li class="nav-link-btn {{ request()->is('complaints*') ? 'active' : '' }}">
                        <a class="hoveradd2" href="{{ url('complaints') }}">
                           <i class="material-icons icon">editor_choice</i>
            ...
            <li class="nav-link">
               <a class="collapsed hoveradd" data-toggle="collapse" href="#supportMenu" aria-expanded="false">
                  <i class="material-icons icon">headset</i>
                  ...
                  <ul class="navbarDropdownProfileavd">
                     ...
                     <li class="nav-link-btn {{ request()->is('beatdetail*') ? 'active' : '' }}">
                        <a class="hoveradd2" href="{{ url('beatdetail') }}">
                           <i class="material-icons icon">opacity</i>
            ...
            <li class="nav-link {{ request()->is('reports*') ? 'active' : '' }}">
               ...
               <div class="collapse" id="tasksMenu" style="">
                  <ul class="navd">
                     ...
                     <li class="nav-link-btn {{ request()->is('reports/reports_sale*') || request()->is('reports/fos_rating*') || request()->is('reports/primary_sales*') || request()->is('reports/secondary_sales*') || request()->is('reports/product_analysis_qty*') || request()->is('reports/product_analysis_branch*') || request()->is('reports/product_analysis_value*') || request()->is('reports/group_wise_analysis*') ? 'active' : '' }}">
                        <a class="hoveradd2" data-toggle="collapse" href="#salesReportsMenu" aria-expanded="false">
                           <i class="material-icons icon">check_circle</i>
                           <span>Sales</span>
            ...
            <li class="nav-link-btn" style="display:none;">
               <a class="hoveradd2" href="{{ url('reports/per_day_counter_visit_report') }}">
                  <i class="material-icons icon">store</i>
            ...
            <li class="nav-link-btn ">
               <a class="hoveradd2" data-toggle="collapse" href="#customerReportsMenu" aria-expanded="false">
                  <i class="material-icons icon">loyalty</i>
                  <span>Customers</span>
            ...
            <li class="nav-link-btn ">
               <a class="hoveradd2" data-toggle="collapse" href="#loyaltyMenu" aria-expanded="false">
                  <i class="material-icons icon">loyalty</i>
                  <span>Loyalty</span>
