    ...
    <div class="wrapper">
        <nav class="sidebar">
            ...
            <div class="menu-bar">
                    ...
                    <ul class="menu-links">
                        ...
                        <li
                            ...
                            <a class="collapsed hoveradd " data-toggle="collapse" href="#addressMenu"
                                ...
                                <span>
                                    Address Management
                                    <!-- {!! trans('panel.sidemenu.address_master') !!} -->
                                </span>
                        ...
                        <li
                            ...
                            <a class="collapsed hoveradd" data-toggle="collapse" href="#productMenu"
                                ...
                                <span> {!! trans('panel.sidemenu.product_master') !!} Management
                                </span>
                                <div class="d-none mobile_hide">{!! trans('panel.sidemenu.product_master') !!} Management</div>
                            </a>
                                   ...
                                   <p>{!! trans('panel.sidemenu.gifts') !!}</p>
                                    ...
                                    <li class="nav-link-btn {{ request()->is('ware_house*') ? 'active' : '' }}">
                                        <a class="hoveradd2" href="{{ url('ware_house') }}">
                                            ...
                                            <span>Plant</span>
                                            <div class="d-none mobile_hide">Plant</div>
                                        </a>
                                    </li>
                                    @endif
                                </ul>
                        ...
                        <li class="nav-link hide_icon {{ request()->is('dealer_product*') ? 'active' : '' }}">
                            <a class="hoveradd" href="{{ url('dealer_product') }}">
                                ...
                                <span>{!! trans('panel.sidemenu.product_master') !!} Management</span>
                                <div class="d-none mobile_hide">{!! trans('panel.sidemenu.product_master') !!} Management</div>
                            </a>
                        </li>
                        @endif
                        ...
                        <li
                            ...
                            <a class="collapsed hoveradd" data-toggle="collapse" href="#hr" aria-expanded="false">
                                ...
                                <div class="d-none mobile_hide"> {!! trans('panel.sidemenu.hr') !!} Management</div>
                            </a>
                        ...
                        <li
                            ...
                            <a class="hoveradd" data-toggle="collapse" href="#userMenu"
                                ...
                                <div class="d-none mobile_hide"> User Management</div>
                            </a>
                        ...
                        <li class="nav-link-btn {{ request()->is('users*') ? 'active' : '' }}">
                            <a class="hoveradd2" href="{{ url('users') }}">
                                ...
                                <div class="d-none mobile_hide"> User Details</div>
                            </a>
                        </li>
                        @endif
                ...
                <li class="nav-link {{ request()->is('livelocation*') || request()->routeIs('location.live-locator') || request()->routeIs('location.punch-in-locator') || request()->routeIs('location.customer-locator') ? 'active' : '' }}">
            ...
            <li
                ...
                <a class="collapsed hoveradd" data-toggle="collapse" href="#serviceMenu" aria-expanded="false">
                    ...
                    <span> Complaint Management
                    </span>
                    <div class="d-none mobile_hide"> Complaint Management</div>
                </a>
                    ...
                    <ul class="navd">
                        ...
                        <li class="nav-link-btn {{ request()->is('end_user*') ? 'active' : '' }}">
                            <a class="hoveradd2" href="{{ url('end_user') }}">
                                ...
                                <span>Complaint Users</span>
                                <div class="d-none mobile_hide"> Complaint Users</div>
                            </a>
                        </li>
                        @endif
                    </ul>
            ...
            <li
                ...
                <a class="collapsed hoveradd" data-toggle="collapse" href="#orderMenu" aria-expanded="false">
                    ...
                    <span>{!! trans('panel.sidemenu.orders') !!} Management</span>
                    <div class="d-none mobile_hide"> {!! trans('panel.sidemenu.orders') !!} Management</div>
                </a>
            ...
            <li
                ...
                <a class="collapsed hoveradd" data-toggle="collapse" href="#settingMenu" aria-expanded="false">
                    ...
                    <span> {!! trans('panel.sidemenu.setting_master') !!} Management
                    </span>
                    <div class="d-none mobile_hide"> {!! trans('panel.sidemenu.setting_master') !!} Management</div>
                </a>
            ...
            <li class="nav-link {{ request()->is('reports*') ? 'active' : '' }}">
                <a class="collapsed hoveradd" data-toggle="collapse" href="#tasksMenu" aria-expanded="false">
                    ...
                    <span> Reports Management
                    </span>
                    <div class="d-none mobile_hide"> Reports Management</div>
                </a>
                <div class="collapse" id="tasksMenu" style="">
                    <ul class="navd">
                        ...
                        <li
                            class="nav-link-btn add_icon {{ request()->is('tours*') || request()->is('reports/customervisit*') || request()->is('reports/attendancereport') || request()->is('reports/attendancereportSummary') || request()->is('reports/user-monthly-analysis*') || request()->is('reports/reports_sale*') || request()->is('reports/fos_rating*') || request()->is('reports/primary_sales*') || request()->is('reports/secondary_sales*') || request()->is('reports/product_analysis_qty*') || request()->is('reports/product_analysis_branch*') || request()->is('reports/product_analysis_value*') || request()->is('reports/group_wise_analysis*') || request()->is('reports/asm_rating*') || request()->is('reports/ch_rating*') ? 'active' : '' }}">
                                ...
                                <ul class="navd">
                                    ...
                                    <li class="nav-link-btn {{ request()->is('reports/user-monthly-analysis*') ? 'active' : '' }}">
                                        <a class="hoveradd2" href="{{ route('reports.user-monthly-analysis') }}">
                                            ...
                                            <span>User Monthly Analysis Report</span>
                                            <div class="d-none mobile_hide">User Monthly Analysis Report</div>
                                        </a>
                                    </li>
                                    @endif
                                    @if(auth()->user()->can('tours'))
                                    ...
                                    <li class="nav-link-btn {{ request()->is('reports/customervisit*') ? 'active' : '' }}">
                                        <a class="hoveradd2" href="{{ url('reports/customervisit') }}">
                                            ...
                                            <div class="d-none mobile_hide">Checkin-Checkout</div>
                                        </a>
                                    </li>
                                    @endif
            ...
            <li class="nav-link-btn">
                <div class="collapse" id="customerReportsMenu" style="">
                    <ul class="navd">
                        ...
                        <li class="nav-link-btn {{ request()->is('promotional_activities*') ? 'active' : '' }}">
                            <a class="hoveradd2" href="{{ url('promotional_activities') }}">
