                              ...
                              @foreach($orders['orderdetails'] as $index => $rows )
                                 ...
                                 <tr id='addr0'>
                                    ...
                                    <td>
                                       ...
                                       {!! $rows['products']['product_name'] !!} {!! $rows['products']['product_code']??'' !!} <br>
                                    </td>
                                    <td>
                               ...
                               <?php
                                ...
                                <?php 
                                 ...
                                 ?>
                                    ...
                                    <td class="td-actions text-center"><a class="remove-rows remove btn btn-danger btn-xs"><i class="fa fa-minus"></i></a></td>
                                 </tr>
                                 <tr id='addr1'></tr>
                                 @endif
                              @endforeach
