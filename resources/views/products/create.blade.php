        ...
        <div class="card">
          ...
          <div class="card-body">
            ...
            <!-- <div class="col-md-6">
              ...
              <div class="col-md-6">
                <div class="input_section">
                  <label class="col-form-label">Material No</label>
                  <div class="form-group has-default bmd-form-group">
              ...
              <div class="col-md-6">
                <div class="input_section">
                  <label class="c ol-form-label">Material Group<span class="text-danger"> *</span></label>
                  <div class="form-group has-default bmd-form-group">
                    <input type="text" name="specification" class="form-control" rows="4" maxlength="200" required value="{!! old( 'specification', $products['specification']) !!}">
                    @if ($errors->has('specification'))
                    <div class="error col-lg-12">
              ...
              <div class="col-md-6">
                <div class="input_section">
                  <label class="col-form-label">Material Grp<span class="text-danger"> *</span></label>
                  <div class="form-group has-default bmd-form-group">
              ...
              <div class="col-md-6">
                <div class="input_section">
                  ...
                  <div class="form-group has-default bmd-form-group">
                    ...
                    <input
                        type="hidden"
                        name="detail[1][detail_id]"
                        value="{{ $products->productdetails[0]->id ?? '' }}"
                    >
                    <input
                        type="number"
                        name="detail[1][price]"
                        ...
                        step="0.01"
                        min="0"
                        value="{{ old('detail.1.price', optional($products->productdetails->first())->price) }}"
                    />
                    @if ($errors->has('hsn_sac'))
                    <div class="error col-lg-12">
                      <p class="text-danger">{{ $errors->first('hsn_sac') }}</p>
