                ...
                <div class="col-md-9">
                  <div class="form-group has-default bmd-form-group">
                    ...
                    @if ($errors->has('product_no'))
                      <div class="error col-lg-12"><p class="text-danger">{{ $errors->first('product_no') }}</p></div>
                    @endif
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-9">
                  <div class="form-group has-default bmd-form-group">
                    ...
                    @if ($errors->has('part_no'))
                      <div class="error col-lg-12"><p class="text-danger">{{ $errors->first('part_no') }}</p></div>
                    @endif
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-9">
                  <div class="form-group has-default bmd-form-group">
                    ...
                    @if ($errors->has('specification'))
                      <div class="error col-lg-12"><p class="text-danger">{{ $errors->first('specification') }}</p></div>
                    @endif
                  </div>
                </div>
              </div>
                ...
                <div class="col-md-9">
                  <div class="form-group has-default bmd-form-group">
                    ...
                    @if ($errors->has('model_no'))
                      <div class="error col-lg-12"><p class="text-danger">{{ $errors->first('model_no') }}</p></div>
                    @endif
                  </div>
                </div>
              </div>
            ...
            <div class="col-md-6">
              <div class="row">
                ...
                <div class="col-md-9">
                  ...
                  @if ($errors->has('gst'))
                    <div class="error col-lg-12"><p class="text-danger">{{ $errors->first('gst') }}</p></div>
                  @endif
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                ...
                <div class="col-md-9">
                  ...
                  @if ($errors->has('discount'))
                    <div class="error col-lg-12"><p class="text-danger">{{ $errors->first('discount') }}</p></div>
                  @endif
                  </div>
                </div>
              </div>
...
<!--                      <td>
                     ...
                     <td><input type="number" name="detail[{!! $index+1 !!}][price]" class="form-control" value="{!! $rows['price'] !!}" step="0.00" min="0"/></td>
<!--                      <td>
