...
Route::group(['middleware' => ['auth']], function () {
    ...
    Route::get('sales_users/target_users_download/download', [SalesTargetUsersController::class, 'target_users_download'])->name('sales_users.target_users_download.download');
