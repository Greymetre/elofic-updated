...
class Expenses extends Model implements HasMedia
{
  ...
  protected $fillable = ['expenses_type', 'user_id', 'date', 'claim_amount', 'start_km', 'stop_km', 'total_km', 'note', 'checker_status', 'accountant_status', 'created_at', 'updated_at', 'created_by', 'approve_amount', 'reason', 'approve_reject_by','city_id'];
