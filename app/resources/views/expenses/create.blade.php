<x-app-layout>
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header card-header-icon card-header-theme">
                    ...
                    <h4 class="card-title ">{{ trans('panel.global.create') }}
                        {{ trans('panel.expenses.title_singular') }}
                        <span class="pull-right">
                            <div class="btn-group">
                                @if(auth()->user()->can(['expense_access']))
                                <a href="{{ url('expenses') }}" class="btn btn-just-icon btn-theme"
                                    title="{!! trans('panel.expenses_type.title_singular') !!} {!! trans('panel.global.list') !!}"><i
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route("expenses.store") }}" enctype="multipart/form-data"
                                ...
                                <div class="input_section">
                                    ...
                                    <div class="form-group has-default bmd-form-group">
                                        <select name="city_id" id="city_id"
                                            class="form-control {{ $errors->has('city_id') ? 'is-invalid' : '' }} select2">
                        ...
                        @endforeach  -->
                                ...
                                <div class="input_section">
                                    ...
                                    <div class="form-group has-default bmd-form-group">
                                        <input placeholder="Start Km"
                                            ...
                                            type="text" name="start_km" id="start_km" value="{{ old('start_km', '') }}"
                                ...
                                <div class="input_section">
                                    ...
                                    <div class="form-group has-default bmd-form-group">
                                        <input placeholder="Stop Km"
                                            ...
                                            type="text" name="stop_km" id="stop_km" value="{{ old('stop_km', '') }}"
                                            maxlength="200" autocomplete="off">
                                ...
                                <div class="input_section">
                                    ...
                                    <div class="form-group has-default bmd-form-group">
                                        <input placeholder="Total Km"
                                            ...
                                            type="text" name="total_km" id="total_km" value="{{ old('total_km', '') }}"
                                            maxlength="200" autocomplete="off">
                                ...
                                <div class="input_section">
                                    ...
                                    <div class="form-group has-default bmd-form-group">
                                        <input placeholder="Note"
                                            ...
                                            type="text" name="note" id="note" value="{{ old('note', '') }}" required
                                            autocomplete="off">
                                        @if($errors->has('note'))
                                        <div class="invalid-feedback">
                                            {{ $errors->first('note') }}
                            ...
                            <div class="col-md-6">
                                <div class="input_section">
                                    <label class="col-form-label">{!! trans('panel.expenses.fields.expense_file')
                                        !!}</label>
    ...
    $(document).ready(function() {
        ...
        // ====================== 2. LOAD EXPENSE TYPES WHEN EMPLOYEE IS SELECTED ======================
        ...
        // ====================== 3. EXPENSE TYPE CHANGE (Show/Hide KM Fields) ======================
        ...
        $(".calcu").on('keyup', function() {
            ...
            var stop_km = parseFloat($('#stop_km').val()) || 0;

            var total_km = Math.abs(stop_km - start_km);

            $("#total_km").val(total_km);

            var rate = parseFloat($('#rate').val()) || 0;
            var final_claim = (total_km * rate).toFixed(2);
