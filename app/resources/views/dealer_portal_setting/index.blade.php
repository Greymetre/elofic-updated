...
<!-- <div class="card-body">
     ...
     <div class="col-md-6">
                  ...
                  <div class="col-md-6">
                     ...
                     @if(isset($dealer_portal_setting) && $dealer_portal_setting->getMedia('dealer_portal_slider_image')->count() > 0 && file_exists($dealer_portal_setting->getMedia('dealer_portal_slider_image')[0]->getPath()))
