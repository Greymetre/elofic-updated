<x-app-layout>
                        ...
                        <span class="">
                            <div class="btn-group header-frm-btn">
                                <div class="next-btn">
                                    ...
                                    <form action="{{ URL::to('city-upload') }}" class="form-horizontal" method="post"
                                        ...
                                        <div class="input-group">
                                            ...
                                            <div class="input-group-append">
                                                <button class="btn btn-just-icon btn-theme"
                                                    title="{!!  trans('panel.global.upload') !!} {!! trans('panel.city.title') !!}">
                                    ...
                                    <a href="{{ URL::to('city-download') }}" class="btn btn-just-icon btn-theme"
                                        title="{!!  trans('panel.global.download') !!} {!! trans('panel.city.title') !!}"><i
                                            class="material-icons">cloud_download</i></a>
                                    @endif
                                    @if(auth()->user()->can(['city_template']))
                                    <a href="{{ URL::to('city-template') }}" class="btn btn-just-icon btn-theme"
                                        title="{!!  trans('panel.global.template') !!} {!! trans('panel.city.title_singular') !!}"><i
                                            class="material-icons">text_snippet</i></a>
                                    @endif
                                    @if(auth()->user()->can(['city_create']))
                                    <a data-toggle="modal" data-target="#createcity"
                                        class="btn btn-just-icon btn-theme create"
                                        title="{!!  trans('panel.global.add') !!} {!! trans('panel.city.title_singular') !!}"><i
    ...
    <!-- Modal -->
    <div class="modal fade bd-example-modal-lg" id="createcity" role="dialog" aria-labelledby="exampleModalLabel"
        aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content card">
                <div class="card-header card-header-icon card-header-theme">
                    ...
                    <h4 class="card-title"><span class="modal-title">{!! trans('panel.global.add') !!}</span> {!!
                        trans('panel.city.title_singular') !!}
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="input_section">
                                    <label class="col-form-label">{!! trans('panel.city.city_name') !!} <span
                                            class="text-danger"> *</span></label>

                                    <div class="form-group has-default bmd-form-group">
                                        <input type="text" name="city_name" id="city_name" class="form-control"
                                            value="{!! old( 'city_name') !!}" maxlength="200" required>
                            ...
                            <div class="col-md-6">
                                <div class="input_section">
                                    <label class="col-form-label">{!! trans('panel.city.district') !!}<span
                                            class="text-danger"> *</span></label>
        ...
        $(function() {
            ...
            var table = $('#getcity').DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'districtname.district_name',
                        name: 'districtname.district_name',
                        "defaultContent": ''
                    },
                    {
            ...
            $(document).on('click', '.edit', function() {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#district_id").append('<option value="' + data.district_id +
                            '" selected="selected">' + data.district_name + '</option>');
                        $('#city_id').val(data.id);
