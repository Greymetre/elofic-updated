                ...
                <form method="GET" action="{{ URL::to('attendance-download') }}">
                  <div class="d-flex flex-row">
                    ...
                    <div class="p-2" style="width: 250px;">
                      <select class="selectpicker" multiple name="branch_id" id="branch_id" data-style="select-with-transition" title="Select Zone">
            ...
            <div class="card tour-card border-info shadow-sm h-55">
                ...
                <div class="card-body text-dark">
                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-7"><span id="tour_objective_display">-</span></div>
                    </div>
