...
class CustomerApiController extends Controller
{
    ...
    public function distributors(Request $request)
    {
        try {
            ...
            // Pagination only when page is passed
    ...
    /* =============================================
       Secondary Customer List API
    ============================================= */
    // public function secondaryCustomers()
    // {
    //     $customers = SecondaryCustomer::with([
    ...
    public function secondaryCustomers()
    {
        ...
        $allowedTypes = ['RETAILER', 'GARAGE', 'WORKSHOP', 'MECHANIC'];
        ...
        try {
            ...
            // Apply type filter only if type is passed
            ...
            // Restrict filter (exclude type)
            $restrict = strtoupper(request()->query('restrict'));
            
            if (!empty($restrict) && in_array($restrict, $allowedTypes)) {
                $query->where('type', '!=', $restrict);
            }

            // If page parameter exists => paginate
            if (request()->filled('page')) {
