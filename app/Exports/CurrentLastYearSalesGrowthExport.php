   ...
   public function map($data): array
   {
    ...
    foreach($data['months'] as $key=>$month) {
        ...
        if($month == 'Apr' && $f_year_array[0] == $year[$key]) {
            ...
            $response[2] = isset($sales_data_last_year->achievements_last_year) ? $sales_data_last_year->achievements_last_year : '';
            $response[3] = isset($sales_data_current_year->achievements_current_year) ? $sales_data_current_year->achievements_current_year : '';
    ...
    foreach($data['months'] as $key=>$month) {
        ...
        if($month == 'May' && $f_year_array[0] == $year[$key]) {
            $currentYear = $f_year_array[0];
                        ...
                        $response[5] = isset($sales_data_last_year->achievements_last_year) ? $sales_data_last_year->achievements_last_year : '';
                        $response[6] = isset($sales_data_current_year->achievements_current_year) ? $sales_data_current_year->achievements_current_year : '';
                        if (isset($sales_data_last_year->achievements_last_year) && isset($sales_data_current_year->achievements_current_year)) {
                            $lastYearAchievements = $sales_data_last_year->achievements_last_year;
                            $currentYearAchievements = $sales_data_current_year->achievements_current_year;
        ...
        $year = explode(',',$data['years']);
                ...
                if($month == 'May' && $f_year_array[0] == $year[$key]) {
                    $currentYear = $f_year_array[0];
                                ...
                                $response[8] = isset($sales_data_last_year->achievements_last_year) ? $sales_data_last_year->achievements_last_year : '';
                                $response[9] = isset($sales_data_current_year->achievements_current_year) ? $sales_data_current_year->achievements_current_year : '';
                                if (isset($sales_data_last_year->achievements_last_year) && isset($sales_data_current_year->achievements_current_year)) {
                                    $lastYearAchievements = $sales_data_last_year->achievements_last_year;
                                    $currentYearAchievements = $sales_data_current_year->achievements_current_year;
        ...
        $year = explode(',',$data['years']);
                ...
                if($month == 'May' && $f_year_array[0] == $year[$key]) {
                    $currentYear = $f_year_array[0];
                                ...
                                $response[14] = isset($sales_data_last_year->achievements_last_year) ? $sales_data_last_year->achievements_last_year : '';
                                $response[15] = isset($sales_data_current_year->achievements_current_year) ? $sales_data_current_year->achievements_current_year : '';
                                if (isset($sales_data_last_year->achievements_last_year) && isset($sales_data_current_year->achievements_current_year)) {
                                    $lastYearAchievements = $sales_data_last_year->achievements_last_year;
                                    $currentYearAchievements = $sales_data_current_year->achievements_current_year;
        ...
        $year = explode(',',$data['years']);
                ...
                if($month == 'May' && $f_year_array[0] == $year[$key]) {
                    $currentYear = $f_year_array[0];
                                ...
                                $response[17] = isset($sales_data_last_year->achievements_last_year) ? $sales_data_last_year->achievements_last_year : '';
                                $response[18] = isset($sales_data_current_year->achievements_current_year) ? $sales_data_current_year->achievements_current_year : '';
                                if (isset($sales_data_last_year->achievements_last_year) && isset($sales_data_current_year->achievements_current_year)) {
                                    $lastYearAchievements = $sales_data_last_year->achievements_last_year;
                                    $currentYearAchievements = $sales_data_current_year->achievements_current_year;
        ...
        $year = explode(',',$data['years']);
                ...
                if($month == 'May' && $f_year_array[0] == $year[$key]) {
                    $currentYear = $f_year_array[0];
                                ...
                                $response[20] = isset($sales_data_last_year->achievements_last_year) ? $sales_data_last_year->achievements_last_year : '';
                                $response[21] = isset($sales_data_current_year->achievements_current_year) ? $sales_data_current_year->achievements_current_year : '';
                                if (isset($sales_data_last_year->achievements_last_year) && isset($sales_data_current_year->achievements_current_year)) {
                                    $lastYearAchievements = $sales_data_last_year->achievements_last_year;
                                    $currentYearAchievements = $sales_data_current_year->achievements_current_year;
        ...
        $year = explode(',',$data['years']);
                ...
                if($month == 'May' && $f_year_array[0] == $year[$key]) {
                    $currentYear = $f_year_array[0];
                                ...
                                $response[26] = isset($sales_data_last_year->achievements_last_year) ? $sales_data_last_year->achievements_last_year : '';
                                $response[27] = isset($sales_data_current_year->achievements_current_year) ? $sales_data_current_year->achievements_current_year : '';
                                if (isset($sales_data_last_year->achievements_last_year) && isset($sales_data_current_year->achievements_current_year)) {
                                    $lastYearAchievements = $sales_data_last_year->achievements_last_year;
                                    $currentYearAchievements = $sales_data_current_year->achievements_current_year;
