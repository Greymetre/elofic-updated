...
class OrderExport implements FromCollection,WithHeadings,ShouldAutoSize,WithMapping
{
    ...
    {
        return ['id','Order Date','Retailer ID','Customer','Customer Name', 'Dealer ID','Dealer & Distributor Name', 'User Name' ,'Order No', 'Order ID', 'Order Status', 'Product Name', 'Product ID', 'Product Detail', 'Product Stage','kW', 'HP','Suc x Del','Category','Subcategory','Quantity', 'Shipped Qty', 'Price', 'Total', 'Status','Employee Code','Branch','Division','Designation'];
    }
