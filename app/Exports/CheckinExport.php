...
//     {
//         return CheckIn::with('beatschedule', 'customer', 'user', 'orders', 'visitreport', 'visitreport.visittypename')->where(function ($query) {
//             if ($this->user_id) {
...
//             isset($data['user']['employee_codes']) ? $data['user']['employee_codes'] : '',
//             isset($data['user']['name']) ? $data['user']['name'] : '',
//             isset($data['user']['getdesignation']['designation_name']) ? $data['user']['getdesignation']['designation_name'] : '',
//             isset($data['user']['getdivision']['division_name']) ? $data['user']['getdivision']['division_name'] : '',
...
//             isset($data['customer']['customertypes']['customertype_name']) ? $data['customer']['customertypes']['customertype_name'] : '',
//             isset($data['customer']['name']) ? $data['customer']['name'] : '',
//             isset($data['customer']['mobile']) ? $data['customer']['mobile'] : '',
//             isset($data['beatschedule']['beats']['beat_name']) ? $data['beatschedule']['beats']['beat_name'] : '',
//             isset($data['customer']['customeraddress']['cityname']['city_name']) ? $data['customer']['customeraddress']['cityname']['city_name'] : '',

//             isset($data['customer']['customeraddress']['districtname']['district_name']) ? $data['customer']['customeraddress']['districtname']['district_name'] : '',


//             isset($data['customer']['customeraddress']['address1']) ? $data['customer']['customeraddress']['address1'] . ' ' . $data['customer']['customeraddress']['address2'] : '',
//             $data['customer'] ? ((date("Y-m-d", strtotime($data['customer']['created_at'])) == date("Y-m-d", strtotime($data['checkin_date']))) ? 'New' : 'Existing') : '-',
//             isset($data['visitreport']['visittypename']['type_name']) ? $data['visitreport']['visittypename']['type_name'] : '',
//             isset($data['visitreport']['description']) ? $data['visitreport']['description'] : '',
...
->get();
    ...
    public function map($data): array
    {
        ...
        $district =
            ...
            ?? $entity?->billing_district->district_name
            ?? '-';
